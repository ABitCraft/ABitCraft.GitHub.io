...
*本译文来自 [王刚](http://www.beiww.com/doc/oss/smart-questions.html) ，部分细节对照原文有调整。*
...
Translations: [Arabic](http://www.abdulibrahim.com/كيف-تطرح-الأسئلة-بطريقة-ذكية/) [Bahasa Indonesian](http://bulsara.host.sk/index.php?p=2005) [Belorussian](http://www.fatcow.com/edu/smart-questions-by) [Brazilo-Portuguese](http://www.istf.com.br/perguntas/) [Chinese](http://www.wapm.cn/smart-questions/smart-questions-zh.html) [Czech](http://www.autoteilexxl.de/edu/?p=729) [Dutch](http://docs.jaspervries.nl/smart-questions/) [French](http://www.gnurou.org/documents/smart-questions-fr.html) [Georgian](http://maxo127.narod.ru/Geo/Articles/smart-questions_ge.html) [German](http://www.tty1.net/smart-questions_de.html) [Greek](http://www.dionyziz.com/howto-smart-questions-gr/) [Hebrew](http://www.penguin.org.il/essays/smart-questions-he.html) [Japanese](http://www.ranvis.com/articles/smart-questions.ja.html) [Polish](http://rtfm.killfile.pl/) [Portuguese](http://www.celiojunior.com.br/comofazerperguntas.htm) [Romanian](http://wiki.lug.ro/mediawiki/index.php/Cum_se_pun_întrebări_în_mod_inteligent) [Russian](http://maddog.sitengine.ru/smart-question-ru.html) [Serbian](http://www.autoersatzteile.de/blog/how-to-ask-questions-the-smart-way-in-serbian) [Spanish](http://www.sindominio.net/ayuda/preguntas-inteligentes.html) [Swedish](http://www.pkwteile.de/wissen/sa-att-staella-fragor-pa-ett-smart-saett) [Thai](http://wiki.opentle.org/Smart-questions) 
...
（欢迎对本文指正，可以将建议发至 <esr@thyrsus.com> 或 <respond-auto@linuxmafia.com>。 请注意，本文不想成为一般性的 [网络礼仪](http://www.ietf.org/rfc/rfc1855.txt) 指南，我一般会拒绝那些与引出技术论坛中有用的回答不特别相关的建议。）
...
使用纯文本而不是 HTML（超文本标注语言）（ [关闭 HTML](http://www.birdhouse.org/etc/evilmail.html) 并不难）
...
记住，还有许多其它用户并未经历你遇到的问题，否则你在阅读文档或搜索网页时就应该发现了（你在报怨前已经做了这些，[是吧](http://www.catb.org/~esr/faqs/smart-questions.html#before) ？）。这也意味着很有可能是你弄错了而不是软件本身有问题。
...
最精确描述代码问题的方法是提供一个能展示问题的最小测试样例。什么是最小测试样例？它是对问题的展现，只需要刚好能够重现非预期行为的代码即可。如何生成一个最小测试样例？如果你知道哪一行或哪一段代码会产生问题，将其复制并提供刚好够用的外围支撑代码以构成一个完整的样例（够用是指源码刚好能被编译器、解释器或任何处理它的程序所接受）。如果你不能将问题缩小到特定的段落，复制源码并去除那些与问题无关的代码段。你能提供的最小测试样例越小越好（参见 [量不在多，精炼则灵](http://www.catb.org/~esr/faqs/smart-questions.html#volume) ）。
...
一般来说，避免提“是或否”类型的问题，除非你想得到 [“是或否”](http://homepage.ntlworld.com./jonathan.deboynepollard/FGA/questions-with-yes-or-no-answers.html) 类型的回答。
...
问：[我到哪可以找到某程序或 X 资源？](http://www.catb.org/~esr/faqs/smart-questions.html#idp54143184)

问：[我怎样用 X 做 Y？](http://www.catb.org/~esr/faqs/smart-questions.html#idp54145856)

问：[如何配置我的 shell 提示？](http://www.catb.org/~esr/faqs/smart-questions.html#idp54148208)

问：[我可以用 Bass-o-matic 文件转换工具将 AcmeCorp 文档转为 TeX 格式吗？](http://www.catb.org/~esr/faqs/smart-questions.html#idp54150832)

问：[我的{程序、配置、SQL 语句}不运行了](http://www.catb.org/~esr/faqs/smart-questions.html#idp54153392)

问：[我的视窗电脑出问题了，你能帮忙吗？](http://www.catb.org/~esr/faqs/smart-questions.html#idp54157472)

问：[我的程序不运行了，我认为系统工具X有问题](http://www.catb.org/~esr/faqs/smart-questions.html#idp54160944)

问：[我安装 Linux 或 X 遇到困难，你能帮忙吗？](http://www.catb.org/~esr/faqs/smart-questions.html#idp54163344)

问：[我如何才能破解超级用户口令/盗取通道操作员的特权/查看某人的电子邮件？](http://www.catb.org/~esr/faqs/smart-questions.html#idp54167648)
...
答：	
如果你有足够的智慧提这个问题，你也该有足够的智慧去 [“读读该死的手册”（RTFM）](http://www.catb.org/~esr/faqs/smart-questions.html#rtfm) ，然后自己去找出来。
...
这个问题在乞求得到 [“搜搜该死的网络”（STFW）](http://www.catb.org/~esr/faqs/smart-questions.html#rtfm) 式的回复。
...
态度 *和善* 一点。问题带来的压力常使人显得无礼或愚蠢，其实并不是这样。
