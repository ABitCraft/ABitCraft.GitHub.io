...
+ `MacBook Air`、`Shadowsocks`、`Surge`、`BandwagonHOST`
...
+ FFmpeg命令行工具：写过[用FFmpeg来生成GIF动图](http://bitandliteracy.github.io/FFmpeg-for-GIF)的批处理脚本，会用FFmpeg来制作硬字幕。
...
> + [《黑客行为：一种应用哲学》](http://bitandliteracy.github.io/hacking)用于离线第11期：“OFFLINE · 重访黑客”
